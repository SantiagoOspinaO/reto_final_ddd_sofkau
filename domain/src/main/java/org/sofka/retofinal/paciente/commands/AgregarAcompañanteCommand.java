...
public class AgregarAcompañanteCommand extends Command {

    private final PacienteId pacienteId;
    private final AcompanianteId acompanianteId;
    private final InformacionPersonal informacionPersonal;

    public AgregarAcompañanteCommand(PacienteId pacienteId, AcompanianteId acompanianteId, InformacionPersonal informacionPersonal) {
